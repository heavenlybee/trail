  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data)
      {
        ...
        window.location.href='/facullitylogin'
      }
      else{
        alert('login failed')
        window.location.href='/faculitysignup'
      }
        ...
        <Paper elevation={10}>
          ...
          <Stack
            ...
            <Typography paragraph align='center'>
              ...
              <Link component={RouterLink} to='/faculitylogin'>
                Login here
              </Link>
            </Typography>
          </Stack>
